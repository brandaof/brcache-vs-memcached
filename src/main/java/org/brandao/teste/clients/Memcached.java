...
public class Memcached implements CacheClient{

	private static final String PUT_HEADER = "set {name} 0 0 {len}\r\n";
	
	private static final String GET_HEADER = "get {name}\r\n";
	...
	public Memcached() throws UnknownHostException, IOException{
		this.con    = new Socket("localhost", 11211);
